 ...
 # if two hands detected
        if len(co) == 2:
            ...
            try:
                ...
                continue
# straight line equation for steering
            a = 1 + m ** 2
            ...
            if m != 0:
# perpendicular line equation for steering
                ap = 1 + ((-1 / m) ** 2)
...
# straight
                ...
                cv2.putText(image, "keep straight", (50, 50), font, 2.5, (255, 255, 255), 2, cv2.LINE_AA)
                if ybp > yap:
                    cv2.line(image, (int(xbp), int(ybp)), (int(xm), int(ym)), (255, 255, 255), 20)
                else:
                    cv2.line(image, (int(xap), int(yap)), (int(xm), int(ym)), (255, 255, 255), 20)
# back
        if len(co) == 1:
            print("keeping back")
            keyinput.release_key('a')
            ...
            cv2.putText(image, "keeping back", (50, 50), font, 1.0, (255, 255, 255), 2, cv2.LINE_AA)
